            ...
            <div className="relative w-full h-screen overflow-hidden">
              ...
              <picture>
                ...
                <img
                  ...
                  className="w-full h-screen object-cover transform scale-100 transition-transform duration-[2000ms] ease-out hover:scale-105"
                  loading="lazy"
                />
              </picture>
              ...
              <div className="absolute inset-0 flex flex-col md:flex-row items-start md:items-center justify-between px-6 md:px-24 py-10 z-10">
                ...
                <div className="text-white max-w-xl mt-auto mb-8 md:mt-0 md:mb-0">
                  <h2 className="text-lg sm:text-xl md:text-3xl font-semibold mb-3 animate-slide-up">
                    {slide.description}
                  </h2>
                  <p className="text-xs sm:text-sm md:text-lg animate-fade-in-text delay-300">
                    {slide.subtext}
                  </p>
                </div>

                {/* Vertical Menu (Desktop Only) */}
                <div className="hidden md:flex flex-col absolute right-4 top-1/2 transform -translate-y-1/2 space-y-2 animate-fade-in-right">
                    ...
                    {[
                      ...
                      <li key={index}>
                        <a
                          ...
                          className={`group flex items-center justify-start bg-black/80 px-2 py-2 text-sm font-medium w-40 transition-all duration-300 relative`}
                        >
                          <span
                            className={`h-6 w-[2px] bg-white transition-all duration-300 ${
                          ...
                          <span
                            className={`ml-4 text-white transition-all duration-300
                              ...
                              pointer-events-none
                              ${menu === item.label ? "opacity-100 translate-x-0 pointer-events-auto" : ""}
                            `}
                          >
                            {item.label}
                          </span>
